...
type ActionType = addPostACType | setUserProfileActionType | setUserStatusACType | deletePostACType | savePhotoSaccessACType
...
export const saveProfile = (profile:photosType):ThunkType => async (dispatch, getState) => {
